...
typedef struct rb_objspace {
    ...
    // TODO: can some of those be replaced?
    struct {
...
static int heap_slots_increment = 10000 / HEAP_OBJ_LIMIT; // TODO: verify 10000
...
slot_sweep(rb_objspace_t *objspace, struct heaps_slot *sweep_slot)
{
    ...
    freed_objects += freed_num;

    gc_clear_slot_bits(sweep_slot);

    if (objspace->heap.freed_blocks < objspace->heap.max_blocks_to_free &&
        final_num + freed_num + empty_num == sweep_slot->header->limit &&
...
gc_marks(rb_objspace_t *objspace)
{
    ...
    */
    ...
    live_after_last_mark_phase = objspace->heap.marked_num;
}
